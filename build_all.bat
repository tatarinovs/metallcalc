...
echo =======================================
call c:\Users\Serg\flutter\bin\flutter.bat build apk --split-per-abi --obfuscate --split-debug-info=build\debug_info
...
echo =======================================
call c:\Users\Serg\flutter\bin\flutter.bat build windows --obfuscate --split-debug-info=build\debug_info
...
echo - releases\Metallcalc_Windows.exe
echo =======================================
pause
